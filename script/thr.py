...
records = []
thr = []
for line in open('../results/naxos/fail_SN_042919_3r_node3/N_t_10000_0_3.txt','r').readlines():
...
thr_file = open('../results/naxos/fail_SN_042919_3r_node3/N_t_10000_0_3_final.txt', 'w')
for item in thr:
  thr_file.write("%s\n" % item)
